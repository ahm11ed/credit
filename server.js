...
const myid = ['713151279911665684']; //هنا بتحط الايدى بتاعك بتاع الديسكورد
const prefix = ['$']; 
...
client.login("NzUxNTg1NTU1MzkyNzU3ODYx.X1LO3A.56nRsnZJVKPVC8pNpabyUtt6S7Y"); 
client2.login("NzUxNTg2MTAwMDE5MDY5MDY5.X1LQJQ.B9Ygzdv8cnoCwHDDNU4sgufSCJo"); 
client3.login("NzUxNTg3NTA0NDk0NDc3MzMy.X1LQrg.dPh_dLHb30KQjF6gsXi5PC8ZG6U"); 
client4.login("NzUxNTg4MTgwMjMwNDA2MTQ0.X1LRQQ.s7DL239UeXRxx07On6_TnmR-Ivs"); 
client5.login("NzUxNTg4NTY0MTA5NzU0Mzk5.X1LRzw.F5c_otLgogmLeDbAFAdDL8yeqQk"); 
client6.login("NzUxNTg5Mjk5OTkyMDAyNTgw.X1LSYQ.wlvcz5fYT8MKKoDro23KNfrZHkQ"); 
